...
![Dictionary](https://img.shields.io/badge/dictionary-4367%20entries-blue.svg)
...
- **词汇标准**：`dictionary/ueguden_dict.json`（词典第七版，**4367 条**，`DICT_REV = 7`）
...
> 第六轮起源文档头部与全仓库一致采用当前词条数（**4367**），`tools/validate.py` 会持续校验此项。
...
- **Lexicon:** 4367 entries (`DICT_REV = 7`)
